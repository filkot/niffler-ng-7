...
public class ApiLoginExtension implements BeforeEachCallback, ParameterResolver {
    ...
    public final ApiLoginExtension restApiLoginExtension() {
    ...
    public void beforeEach(ExtensionContext context) throws Exception {
        AnnotationSupport.findAnnotation(context.getRequiredTestMethod(), ApiLogin.class)
                .ifPresent(apiLogin -> {
                    ...
                    final UserJson userToLogin = getUserJson(apiLogin);
    ...
    @NotNull
    private UserJson getUserJson(ApiLogin apiLogin) {
    ...
    private UserJson addUserData(String username, String password) {
