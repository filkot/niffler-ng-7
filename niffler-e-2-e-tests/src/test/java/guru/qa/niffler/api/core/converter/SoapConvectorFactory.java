...
public class SoapConvectorFactory extends Converter.Factory {
    public static final MediaType XML = MediaType.get("application/xml; charset=utf-8");

    public static SoapConvectorFactory create(@Nonnull String namespace) {
        return new SoapConvectorFactory(null, namespace);
    }

    public static SoapConvectorFactory create(@Nonnull JAXBContext context, @Nonnull String namespace) {
        return new SoapConvectorFactory(context, namespace);
    }

    private final @Nullable JAXBContext context;
    private final @Nonnull String namespace;

    private SoapConvectorFactory(@Nullable JAXBContext context, @Nonnull String namespace) {
